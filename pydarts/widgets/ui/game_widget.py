...
class Ui_game_widget(object):
    def setupUi(self, game_widget):
        ...
        game_widget.resize(1100, 900)
        game_widget.setMinimumSize(QSize(1100, 900))
        game_widget.setMaximumSize(QSize(1100, 900))
        ...
        sizePolicy4.setHeightForWidth(self.turn_order_key_label.sizePolicy().hasHeightForWidth())
        self.turn_order_key_label.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.turn_order_value_label.sizePolicy().hasHeightForWidth())
        self.turn_order_value_label.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.current_player_widget.sizePolicy().hasHeightForWidth())
        self.current_player_widget.setSizePolicy(sizePolicy6)
        ...
        sizePolicy4.setHeightForWidth(self.current_player_key_label.sizePolicy().hasHeightForWidth())
        self.current_player_key_label.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.current_player_value_label.sizePolicy().hasHeightForWidth())
        self.current_player_value_label.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.throws_widget.sizePolicy().hasHeightForWidth())
        self.throws_widget.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.turn_control_widget.sizePolicy().hasHeightForWidth())
        self.turn_control_widget.setSizePolicy(sizePolicy6)
        self.horizontalLayout_5 = QHBoxLayout(self.turn_control_widget)
        self.horizontalLayout_5.setObjectName(u"horizontalLayout_5")
        self.throw_input_line_edit = QLineEdit(self.turn_control_widget)
        self.throw_input_line_edit.setObjectName(u"throw_input_line_edit")

        self.horizontalLayout_5.addWidget(self.throw_input_line_edit)
        ...
        sizePolicy7.setVerticalStretch(13)
        sizePolicy7.setHeightForWidth(self.hint_widget.sizePolicy().hasHeightForWidth())
        self.hint_widget.setSizePolicy(sizePolicy7)
        ...
        sizePolicy8.setHeightForWidth(self.hint_label.sizePolicy().hasHeightForWidth())
        self.hint_label.setSizePolicy(sizePolicy8)
        font = QFont()
        font.setItalic(True)
        ...
        sizePolicy8.setHeightForWidth(self.finish_game_widget.sizePolicy().hasHeightForWidth())
        self.finish_game_widget.setSizePolicy(sizePolicy8)
